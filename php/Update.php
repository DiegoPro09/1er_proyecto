					...
					<p>
							...
							<div class="col-md-6">
								<div class="row">
									<div class="col-md-12">
										...
										<input type="text" name="Nombre_R" class="form-control" id="validationCustom01" value="<?php echo $fila['Nombre']?>" required>
									...
									<div class="col-md-12">
										...
										<input type="text" name="Apellido_R" class="form-control" id="validationCustom02" value="<?php echo $fila['Apellido']?>" required>
										<div class="invalid-feedback">
						...
						<div class="form-row">
						  	...
						  	<div class="col-md-4">
						      	...
						      	<input type="text" name="Numero_Doc" class="form-control"  id="validationCustom05" required value="<?php echo $fila['DNI']?>">
						      	<div class="invalid-feedback">
						...
						<p>
							<div class="form-row">
								...
								<div class="col-md-2">
									...
									<input type="text" name="Sector" class="form-control" id="validationCustom12" value="<?php echo $fila['Sector']?>" required>
									<div class="invalid-feedback">
								...
								<div class="col-md-6">
									...
									<input type="text" name="Motivo" class="form-control" id="validationCustom13" value="<?php echo $fila['Motivo']?>" required>
									<div class="invalid-feedback">
					    ...
					    <p>
							<div class="form-row">
							    <div class="col-md-6">
							      	...
							      	<input type="text" name="Modelo_V" class="form-control" id="validationCustom16" value="<?php echo $fila['Modelo']?>" required>
							      	<div class="invalid-feedback">
							    ...
							    <div class="col-md-6">
							      	...
							      	<input type="text" name="Dominio_V" class="form-control" id="validationCustom17" value="<?php echo $fila['Dominio']?>" required>
							      	<div class="invalid-feedback">
							...
							<div class="form-row">
								<div class="col-md-6">
									<label for="validationCustom18">Licencia de Conducir</label>
							      	<input type="text" name="Lic_Cond" class="form-control" id="validationCustom18" value="<?php echo $fila['Licencia_Conducir']?>" required>
							      	<div class="invalid-feedback">
								...
								<div class="col-md-6">
								    ...
								    <input type="date" name="Vencimiento_C" class="form-control" id="validationCustom19" value="<?php echo $fila['VencimientoLICENCIA']?>" required>
								    <div class="invalid-feedback">
						...
						<p>
							<div class="form-row">
								<div class="col-md-4">
									...
									<input type="text" name="Seguro_V" class="form-control" id="validationCustom20" value="<?php echo $fila['Seguro']?>" required>
									<div class="invalid-feedback">
								...
								<div class="col-md-4">
								    ...
								    <input type="text" name="Poliza_V" class="form-control" id="validationCustom21" value="<?php echo $fila['Poliza']?>" required>
								    <div class="invalid-feedback">
						...
						<p>
							<div class="form-row">
								<div class="col-md-12">
									...
									<input type="text" name="Autorizado_P" class="form-control" id="validationCustom25" value="<?php echo $fila['Autorizado_Por']?>" required >
									<div class="invalid-feedback">
						...
						<p>
							<div class="form-row">
								...
								<div class="col-md-6">
									...
									<input type="text" name="Causa_S" class="form-control" id="validationCustom27" value="<?php echo $fila['Causa']?>">
									<div class="invalid-feedback">
