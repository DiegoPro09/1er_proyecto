<?php
	...
	while($row = $resultado->fetch_assoc())
	{
        ...
        $pdf->Cell(30,6,utf8_decode($row['Vencimiento_R']),1,0,'C');
        $pdf->Cell(40,6,utf8_decode($row['Cert_BuenaConducta']),1,0,'C');
        $pdf->Cell(28,6,utf8_decode($row['VencimientoCERT']),1,1,'C');
        ...
        $pdf->Cell(50,6,utf8_decode($row['Hora_Ingreso']),1,0,'C');
        $pdf->Cell(45,6,utf8_decode($row['Hora_Egreso']),1,0,'C');
        $pdf->Cell(38,6,utf8_decode($row['Sector']),1,0,'C');
        $pdf->Cell(38,6,utf8_decode($row['Motivo']),1,0,'C');
        $pdf->Cell(49,6,utf8_decode($row['Fecha_Alta']),1,0,'C');
        $pdf->Cell(49,6,utf8_decode($row['Fecha_Baja']),1,1,'C');
